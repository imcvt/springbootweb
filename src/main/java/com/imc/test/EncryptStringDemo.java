...
public class EncryptStringDemo {
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        // 1 准备业务参数与密钥
        // 1.1 业务参数文本
        String content = "{\"ai\":\"ooo\",\"name\":\"liujian\",\"idNum\":\"123456\"}";
        // 1.2 密钥
        String secretKey = "415e1df33a835fcdffa7b6892c8c1822";
...
//        System.out.println("业务参数解密结果：" + decryptStr);
        ...
        sb.append("appId test-appId bizId test-bizId id test-id name test-name timestamps 1584949895758");
    ...
    private static byte[] hexStringToByte(String str) {
        ...
        System.out.println("baKeyword==>"+ baKeyword);
        return baKeyword;
    }
}
